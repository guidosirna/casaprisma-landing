      ...
      <footer className="bg-prisma-charcoal text-white py-12 mt-auto">
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex flex-col md:flex-row items-start gap-10 mb-10">
            <img src="/casaprisma-logo-dark.png" alt="Casa Prisma" className="h-8 w-auto shrink-0" />
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-10">
            ...
            <div>
              <p className="text-sm font-medium text-white mb-3">Comunidad</p>
              <nav className="space-y-1.5">
                <Link
                  to="/community"
              ...
              <p className="text-sm font-medium text-white mb-3 mt-6">Contacto</p>
